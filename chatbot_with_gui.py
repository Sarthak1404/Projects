...
conversation = tk.Text(root, width=75, height=20)
conversation.pack()
...
def send_message():
    ...
    if message == "quit":
      ...
      root.after(1500, root.destroy) # wait 1.5 seconds and then destroy the root
    else:
...
def handle_enter(event=None):
    # Call the send_message function when Enter key is pressed
    send_message()
